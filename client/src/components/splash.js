    ...
    return(
      <div className="row splash">
        <div className="col-12 px-5 p-sm-0 px-lg-2 mb-4 col-sm-6 col-lg-5 order-sm-2 text-center">
          <img src={imgRevenue} className="mb-3 mx-auto" alt="person with money" />
        ...
        <div className="col-12 text-center col-sm-6 col-lg-7 text-sm-left order-sm-1">
          ...
          <p className="text-left px-5 px-sm-0 pr-sm-2 pr-lg-5">No more chasing down client payments, or going blindly into new jobs. Cheque Mate helps you deal with, or straight-up avoid, bad clients and overdue invoices.</p>
